...
import { GetWorkflowExecutionWithPhases } from "@/app/actions/workflows/getWorkflowExecutionWithPhases";
...
import { GetWorkflowPhaseDetails } from "@/app/actions/workflows/getWorkflowPhaseDetails";
          ...
          <TableBody>
            {logs.map((log) => (
              <TableRow key={log.id} className="text-muted-foreground">
                <TableCell
                  width={190}
                  className="text-sx text-muted-foreground p-[2x] pl-4"
                >
